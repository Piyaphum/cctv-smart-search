...
tf.flags.DEFINE_integer('max_steps', '271000', 'max steps for training')
    ...
    def network(self, images1, images2, weight_decay):
        with tf.variable_scope('network'):
            ...
            conv1_1 = tf.layers.conv2d(images1, 20, [5, 5], activation=tf.nn.relu,
                kernel_regularizer=tf.keras.regularizers.l2(weight_decay), name='conv1_1')
            ...
            conv1_2 = tf.layers.conv2d(pool1_1, 25, [5, 5], activation=tf.nn.relu,
                kernel_regularizer=tf.keras.regularizers.l2(weight_decay), name='conv1_2')
            ...
            conv2_1 = tf.layers.conv2d(images2, 20, [5, 5], activation=tf.nn.relu,
                kernel_regularizer=tf.keras.regularizers.l2(weight_decay), name='conv2_1')
            ...
            conv2_2 = tf.layers.conv2d(pool2_1, 25, [5, 5], activation=tf.nn.relu,
                kernel_regularizer=tf.keras.regularizers.l2(weight_decay), name='conv2_2')
            ...
            l1 = tf.layers.conv2d(k1, 25, [5, 5], (5, 5), activation=tf.nn.relu,
                kernel_regularizer=tf.keras.regularizers.l2(weight_decay), name='l1')
            l2 = tf.layers.conv2d(k2, 25, [5, 5], (5, 5), activation=tf.nn.relu,
                kernel_regularizer=tf.keras.regularizers.l2(weight_decay), name='l2')

            # Across-Patch Features
            m1 = tf.layers.conv2d(l1, 25, [3, 3], activation=tf.nn.relu,
                kernel_regularizer=tf.keras.regularizers.l2(weight_decay), name='m1')
            pool_m1 = tf.layers.max_pooling2d(m1, [2, 2], [2, 2], padding='same', name='pool_m1')
            m2 = tf.layers.conv2d(l2, 25, [3, 3], activation=tf.nn.relu,
                kernel_regularizer=tf.keras.regularizers.l2(weight_decay), name='m2')
